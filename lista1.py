productos = [
    ...
    ('celular', 'tecnologia', 8950, 1000, 'Samsung LX'),
    ('tablet', 'tecnologia', 12.000, 500, 'Lenovo 10'),
    ('ventilador', 'electrodomestico', 8200, 450, 'Mca. Xenon'),
    ('Cocina', 'electrodomestico', 60.300, 3000, 'Mca Florencia'),
    ('Heladera', 'electrodomestico', 95.600, 1000, 'Mca. TCL. 50lts'),
